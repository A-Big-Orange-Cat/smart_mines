...
import com.jkzz.smart_mines.communication.HslCommunication.Core.Net.NetSupport;
import com.jkzz.smart_mines.communication.HslCommunication.Core.Types.*;
import com.jkzz.smart_mines.communication.HslCommunication.Enthernet.Redis.RedisHelper;
import com.jkzz.smart_mines.communication.HslCommunication.LogNet.Core.HslMessageDegree;
import com.jkzz.smart_mines.communication.HslCommunication.LogNet.Core.ILogNet;
import com.jkzz.smart_mines.communication.HslCommunication.MQTT.MqttControlMessage;
...
import com.jkzz.smart_mines.communication.HslCommunication.WebSocket.WebSocketMessage;
...
public abstract class NetworkBase {
    ...
    /**
     * 组件的日志工具，支持日志记录，只要实例化后，当前网络的基本信息，就以 {@link HslMessageDegree HslMessageDegree.Debug} 等级进行输出<br />
     * The component's logging tool supports logging. As long as the instantiation of the basic network information, the output will be output at {@link HslMessageDegree HslMessageDegree.Debug} "
     */
