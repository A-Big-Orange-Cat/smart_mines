package com.jkzz.smart_mines.communication.HslCommunication.Language;
...
public class DefaultLanguage {
    ...
    public String PanasonicMcC059() {
        return "指令搜索 MC 协议指令表格中不存在与接收数据指令一致的指令时";
    }
    ...
    public String PanasonicMcC05C() {
        return "从指令为位单位（0001）而设备代码是字设备时";
    }
    ...
    public String PanasonicMcC060() {
        return "写入触点数据异常（0/1 以外）";
    }

    public String PanasonicMcC061() {
        return "1. 接收数据数未达到允许起始符内容检查的最低接收字节数 \r\n2. 接收数据数未达到最低接收字节数";
    }
