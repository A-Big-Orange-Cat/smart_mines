...
public interface IReadWriteNet {
     ...
     * @return 带有成功标识的string数据
     */
    OperateResultExOne<String> ReadString(String address, short length, Charset encoding);
     ...
     * @return 带有成功标识的结果类对象
     */
    OperateResult Write(String address, String value, Charset encoding);
     ...
     * @return 带有成功标识的结果类对象
     */
    OperateResult Write(String address, String value, int length, Charset encoding);
