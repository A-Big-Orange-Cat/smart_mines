...
import com.jkzz.smart_mines.communication.HslCommunication.Core.IMessage.MelsecA1EBinaryMessage;
...
public class MelsecA1ENet extends NetworkDeviceBase {
    ...
    public static OperateResultExOne<byte[]> BuildReadCommand(String address, short length, boolean isBit, byte plcNumber) {
        ...
        _PLCCommand[8] = Utilities.getBytes(analysis.Content1.getDataCode())[0];     // 软元件代码（L）
        _PLCCommand[9] = Utilities.getBytes(analysis.Content1.getDataCode())[1];     // 软元件代码（H）
