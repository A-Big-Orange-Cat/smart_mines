<template>
  <div class="info-flex">
      ...
      <div class="operate-layout">
        ...
        <div class="operate-box">
          ...
          <div class="button-box">
            <div class="button-list">
              <div class="button-blue" @click="openWindow('A风门风窗1', 1)">A门风窗1</div>
              <div class="button-blue" @click="openWindow('A风门风窗2', 2)">A门风窗2</div>
            </div>
            <div class="button-list">
              <div class="button-blue" @click="openWindow('B风门风窗3', 3)">B门风窗3</div>
              <div class="button-blue" @click="openWindow('B风门风窗4', 4)">B门风窗4</div>
            </div>
          </div>
        </div>
        <div class="operate-box">
    ...
    <param-modal :visible.sync="paramVisible" deviceType="damperWindow"></param-modal>
