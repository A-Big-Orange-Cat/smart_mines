  ...
  >
    ...
    <el-table
      ...
      >
        ...
        <el-table-column prop="alarmCodeValue" label="报警值"></el-table-column>
        <el-table-column prop="alarmInformation" label="报警信息"> </el-table-column>
        <el-table-column prop="timeMillis" label="报警时间" width="180px">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      this.queryAlarmLog(this.form_query.time_period)
    },
    async queryAlarmLog(time) {
      try {
        const res = await this.$http.post('/log/queryAlarmLog', {
